...
- qualification_gate_readiness: `READY`
...
- admitted: 2, completed: 2, invalid: 0, incomplete: 0
- invocation_provenance_resolved: True
- task_reconciliation_passed: True

## Topology (safe, coarse)

- region_counts: [('us-central1', 1), ('us-east1', 1)]
- machine_type_counts: [('n2-standard-4', 2)]
- provisioning_class_counts: [('ON_DEMAND', 2)]
